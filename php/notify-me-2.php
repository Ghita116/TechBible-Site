...
header('content-type: application/json');
	...
	$email_to = "ghita@myfinderr.com"; // Write your email here to receive the email addresses submitted
    $subject = 'New subscriber from Techbible'; // Write the subject you'll see in your inbox
