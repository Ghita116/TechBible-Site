...
if($_POST) {
    ...
    $to_Email = 'ghitaelhaitmy@gmail.com'; // Write your email here to receive the form submissions
    $subject = 'New message from Techbible'; // Write the subject you'll see in your inbox
